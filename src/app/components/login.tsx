...
import { signIn, signInWithGoogle, checkDeletedAccount, recoverAccount } from '../lib/auth-service';
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center px-4 sm:px-8">
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="w-full max-w-sm">
            ...
            <Button variant="outline" onClick={handleGoogleLogin} disabled={!!isSocialLoading} className="w-full h-11 border-border hover:bg-accent rounded-xl">
